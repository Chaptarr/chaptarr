...
namespace Chaptarr.Http.Extensions
{
    public static class RequestExtensions
    {
        // See src/Chaptarr.Api.V1/Queue/QueueModule.cs
        ...
        public static void DisableCacheForApi(this IHeaderDictionary headers)
        {
            headers.Remove("Last-Modified");
        ...
        {
            // NEVER use immutable - it prevents cache revalidation even with F5
            headers["Cache-Control"] = "max-age=31536000, public";
            headers["Last-Modified"] = BuildInfo.BuildDateTime.ToString("r");
            headers["ETag"] = $"\"{BuildInfo.Version}-{BuildInfo.BuildDateTime.Ticks}\"";
        }
    }
}
