...
{
    public enum ManualImportSelectionSource
    {
        Automatic = 0,
        UserMetadataSuggestion = 1
    }
    ...
    public class ManualImportFile : IEquatable<ManualImportFile>
    {
        ...
        public string ForeignBookTitle { get; set; }
        public string ForeignEditionId { get; set; }
        public string ForeignEditionTitle { get; set; }
        public ManualImportSelectionSource SelectionSource { get; set; }
