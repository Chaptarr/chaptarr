...
namespace NzbDrone.Core.HealthCheck.Checks
{
    public class SystemTimeCheck : HealthCheckBase
    {
        ...
        public SystemTimeCheck(IHttpClient client, IChaptarrCloudRequestBuilder cloudRequestBuilder, ILocalizationService localizationService, Logger logger)
        ...
        public override HealthCheck Check()
        {
            ...
            {
                // If the time service is unavailable (e.g., disabled updates pointing to localhost), do not fail healthcheck
                _logger.Debug(ex, "SystemTimeCheck skipped: time service unavailable");
                return new HealthCheck(GetType());
            }
        }
    }
