...
namespace NzbDrone.Core.Books
{
    public interface ISeriesBookLinkService
    {
        ...
        void InsertMany(List<SeriesBookLink> model, IDbConnection connection, IDbTransaction transaction);
        void UpdateMany(List<SeriesBookLink> model);
        void DeleteMany(List<SeriesBookLink> model);
        void AddLink(SeriesBookLink link);
    }
        ...
        IHandle<BookDeletedEvent>
    {
        ...
        {
            return _repo.GetClaimedBookIdsForSeriesIdentity(mediaType, goodreadsSeriesId);
        }
        ...
        {
            _repo.InsertMany(model, connection, transaction);
        }
