...
{
    public class NarratorMetadata : Entity<NarratorMetadata>
    {
        public NarratorMetadata()
        {
        ...
        public string LocalNarratorId { get; set; }
        ...
        public NarratorStatusType Status { get; set; }
        ...
        public override void UseMetadataFrom(NarratorMetadata other)
        {
            // LocalNarratorId removed - using database IDs directly
            ...
            HardcoverNarratorId = other.HardcoverNarratorId.IsNullOrWhiteSpace() ? HardcoverNarratorId : other.HardcoverNarratorId;
            GoodreadsNarratorId = other.GoodreadsNarratorId.IsNullOrWhiteSpace() ? GoodreadsNarratorId : other.GoodreadsNarratorId;
