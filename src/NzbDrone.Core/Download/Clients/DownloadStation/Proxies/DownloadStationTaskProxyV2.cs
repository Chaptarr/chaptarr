...
namespace NzbDrone.Core.Download.Clients.DownloadStation.Proxies
{
    ...
    {
        private readonly DownloadStationTaskProxyV1 _legacyTaskProxy;

        public DownloadStationTaskProxyV2(IHttpClient httpClient, ICacheManager cacheManager, DownloadStationTaskProxyV1 legacyTaskProxy, Logger logger)
            : base(DiskStationApi.DownloadStation2Task, "SYNO.DownloadStation2.Task", httpClient, cacheManager, logger)
        {
            _legacyTaskProxy = legacyTaskProxy;
        }
        ...
        {
            return _legacyTaskProxy.GetTaskFiles(downloadId, settings);
        }
