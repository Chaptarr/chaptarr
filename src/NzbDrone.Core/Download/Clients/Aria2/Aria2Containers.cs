    ...
    public class Aria2File
    {
        public Aria2File(XElement element)
        {
            foreach (var e in element.XPathSelectElements("./struct/member"))
            {
                ...
                {
                    Index = e.Element("value").GetStringValue();
                }
                else if (name == "length")
                {
                    Length = e.Element("value").GetStringValue();
                }
                ...
                {
                    Selected = e.Element("value").GetStringValue();
                }
            }
        }
        ...
        public bool IsSelected => !string.Equals(Selected, "false", StringComparison.InvariantCultureIgnoreCase);
    }
