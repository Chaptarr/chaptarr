...
namespace NzbDrone.Core.Download.Clients.Deluge
{
    ...
    public class DelugeTorrentDetails
    {
        [JsonProperty(PropertyName = "save_path")]
        public string DownloadPath { get; set; }

        [JsonProperty(PropertyName = "file_priorities")]
        public List<int> FilePriorities { get; set; } = new();

        public List<DelugeTorrentFile> Files { get; set; } = new();
    }

    public class DelugeTorrentFile
    {
