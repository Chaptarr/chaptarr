...
namespace NzbDrone.Core.Download.Clients.NzbVortex
{
    ...
    {
        string DownloadNzb(byte[] nzbData, string filename, int priority, NzbVortexSettings settings, string groupName = null);
        ...
        List<NzbVortexQueueItem> GetQueue(int doneLimit, NzbVortexSettings settings, string groupName = null);
    ...
    public class NzbVortexProxy : INzbVortexProxy
    {
        ...
        public string DownloadNzb(byte[] nzbData, string filename, int priority, NzbVortexSettings settings, string groupName = null)
        {
            var requestBuilder = BuildRequest(settings).Resource("nzb/add")
                                                       .Post()
                                                       .AddQueryParam("priority", priority.ToString());

            var group = groupName ?? settings.MusicCategory;
        ...
        public List<NzbVortexQueueItem> GetQueue(int doneLimit, NzbVortexSettings settings, string groupName = null)
        {
