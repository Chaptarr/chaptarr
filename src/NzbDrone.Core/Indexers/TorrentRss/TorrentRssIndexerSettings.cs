...
namespace NzbDrone.Core.Indexers.TorrentRss
{
    ...
    public class TorrentRssIndexerSettings : ITorrentIndexerSettings
    {
        ...
        [FieldDefinition(1, Label = "Cookie", Privacy = PrivacyLevel.ApiKey, HelpText = "If you site requires a login cookie to access the rss, you'll have to retrieve it via a browser.")]
        ...
        [FieldDefinition(3, Type = FieldType.Number, Label = "Early Download Limit", Unit = "days", HelpText = "Time before release date Chaptarr will download from this indexer, empty is no limit", Advanced = true)]
