...
namespace NzbDrone.Core.Indexers.Newznab
{
    public static class NewznabCategoryFieldOptionsConverter
    {
        ...
        {
            // Keep the configuration dropdown focused on categories that make sense
            // for Chaptarr. Search-time code still honors whatever categories are
            // already configured on the indexer.
