...
namespace NzbDrone.Core.Notifications.Apprise
{
    ...
    public class AppriseSettings : IProviderConfig
    {
        ...
        [FieldDefinition(2, Label = "Apprise Configuration Key", Type = FieldType.Textbox, Privacy = PrivacyLevel.ApiKey, HelpText = "Configuration Key for the Persistent Storage Solution. Leave empty if Stateless URLs is used.", HelpLink = "https://github.com/caronc/apprise-api#persistent-storage-solution")]
        public string ConfigurationKey { get; set; }

        [FieldDefinition(3, Label = "Apprise Stateless URLs", Type = FieldType.Textbox, Privacy = PrivacyLevel.ApiKey, HelpText = "One or more URLs separated by commas identifying where the notification should be sent to. Leave empty if Persistent Storage is used.", HelpLink = "https://github.com/caronc/apprise#productivity-based-notifications")]
