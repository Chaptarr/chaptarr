...
namespace NzbDrone.Core.Notifications.SendGrid
{
    ...
    public class SendGridSettings : IProviderConfig
    {
        ...
        [FieldDefinition(1, Label = "API Key", Privacy = PrivacyLevel.ApiKey, HelpText = "The API Key generated by SendGrid", HelpLink = "https://sendgrid.com/docs/ui/account-and-settings/api-keys/#creating-an-api-key")]
