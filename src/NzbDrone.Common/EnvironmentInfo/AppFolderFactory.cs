...
namespace NzbDrone.Common.EnvironmentInfo
{
    ...
    public class AppFolderFactory : IAppFolderFactory
    {
        ...
        public void Register()
        {
            ...
            {
                throw new ChaptarrStartupException("Cannot create AppFolder, Access to the path {0} is denied", _appFolderInfo.AppDataFolder);
            }
            ...
            {
                throw new ChaptarrStartupException("AppFolder {0} is not writable", _appFolderInfo.AppDataFolder);
            }
