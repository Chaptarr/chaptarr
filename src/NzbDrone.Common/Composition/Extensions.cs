...
namespace NzbDrone.Common.Composition.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IContainer RegisterHttpClients(this IContainer container)
        {
            container.Register<IHttpClient, HttpClient>(Reuse.Singleton, ifAlreadyRegistered: IfAlreadyRegistered.Replace);

            // Note: IIndexerHttpClient is no longer registered here.
            // Indexers now use IIndexerHttpClientFactory to get proxy-specific HTTP clients
            return container;
        }
    }
}
