...
namespace Chaptarr.Api.V1.Config
{
    public class HostConfigResource : RestResource
    {
        ...
        public string OidcAllowedEmails { get; set; }
        public string OidcAllowedEmailDomains { get; set; }
        public bool OidcRequireEmailVerified { get; set; }
        public bool OidcAllowAnyVerifiedUser { get; set; }
    }
    ...
    public static class HostConfigResourceMapper
    {
        public static HostConfigResource ToResource(this IConfigFileProvider model, IConfigService configService)
        {
            ...
            return new HostConfigResource
            {
                ...
                ProxyMode = configService.ProxyMode,
                GlobalProxyId = configService.GlobalProxyId,
                ...
                OidcClientSecret = model.OidcClientSecret,
                OidcScopes = model.OidcScopes,
                OidcAllowedEmails = model.OidcAllowedEmails,
                OidcAllowedEmailDomains = model.OidcAllowedEmailDomains,
                OidcRequireEmailVerified = model.OidcRequireEmailVerified,
                OidcAllowAnyVerifiedUser = model.OidcAllowAnyVerifiedUser
            };
        }
    }
}
