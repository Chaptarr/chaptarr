...
namespace Chaptarr.Api.V1.Notifications
{
    public class NotificationResource : ProviderResource<NotificationResource>
    {
        ...
        public List<AudioBookShelfLibraryMapping> AudioBookShelfLibraryMappings { get; set; }
        public bool AudioBookShelfLibraryMappingsConfigured { get; set; }
        public string LegacyAudiobookLibraryId { get; set; }
        public string LegacyEbookLibraryId { get; set; }
    }
    ...
    public class NotificationResourceMapper : ProviderResourceMapper<NotificationResource, NotificationDefinition>
    {
        public override NotificationResource ToResource(NotificationDefinition definition)
        {
            ...
            resource.OnBookAdded = definition.OnBookAdded;
            ...
            resource.SupportsOnBookAdded = definition.SupportsOnBookAdded;
            ...
            {
                resource.AudioBookShelfLibraryMappings = audioBookShelfSettings.GetLibraryMappings();
                resource.AudioBookShelfLibraryMappingsConfigured = audioBookShelfSettings.HasConfiguredLibraryMappings();
                resource.LegacyAudiobookLibraryId = audioBookShelfSettings.AudiobookLibraryId;
                resource.LegacyEbookLibraryId = audioBookShelfSettings.EbookLibraryId;
            }
        ...
        public override NotificationDefinition ToModel(NotificationResource resource)
        {
            ...
            definition.OnBookAdded = resource.OnBookAdded;
            ...
            definition.SupportsOnBookAdded = resource.SupportsOnBookAdded;
            ...
            if (definition.Settings is AudioBookShelfSettings audioBookShelfSettings &&
                resource.AudioBookShelfLibraryMappings != null)
            {
                audioBookShelfSettings.SetLibraryMappings(resource.AudioBookShelfLibraryMappings);
            }
