...
namespace NzbDrone.Update.UpdateEngine
{
    ...
    public class StartNzbDrone : IStartNzbDrone
    {
        ...
        {
            _logger.Info("Starting Chaptarr");
            if (appType == AppType.Service)
            {
                ...
                {
                    _logger.Warn(e, "Couldn't start Chaptarr Service (Most likely due to permission issues). Falling back to console.");
