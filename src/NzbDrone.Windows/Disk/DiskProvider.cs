...
namespace NzbDrone.Windows.Disk
{
    public class DiskProvider : DiskProviderBase
    {
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        private static extern bool GetFileInformationByHandle(SafeFileHandle hFile, out ByHandleFileInformation fileInformation);
        ...
        public override int? GetFileLinkCount(string path)
        {
            ...
            return checked((int)fileInformation.NumberOfLinks);
        }
    }
}
