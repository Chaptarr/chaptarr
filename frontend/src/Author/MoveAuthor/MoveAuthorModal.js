    ...
    >
      ...
      >
        ...
        <ModalBody>
          {
            destinationRootFolder ?
              translate('MoveAuthorFoldersConfirm', { destinationRootFolder }) :
              translate('MoveAuthorFilesConfirm', { originalPath, destinationPath })
          }
        </ModalBody>
        ...
        <ModalFooter>
          <Button
            ...
            onPress={onSavePress}
          >
            {translate('MoveAuthorNoIllMoveMyself')}
          </Button>
