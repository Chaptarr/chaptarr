...
class Modal extends Component {
  ...
  componentWillUnmount() {
    ...
    // Safety cleanup: remove this modal from openModals array even if not properly closed
    removeFromOpenModals(this._modalId);

    // If this was the last modal and body classes are still applied, clean them up
