...
class TableOptionsModal extends Component {
  ...
  onVisibleChange = ({ name, value }) => {
    const columns = this.props.columns.map((column) => {
      ...
      for (const prop of Object.getOwnPropertyNames(column)) {
        Object.defineProperty(nextColumn, prop, Object.getOwnPropertyDescriptor(column, prop));
      }

      for (const sym of Object.getOwnPropertySymbols(column)) {
        Object.defineProperty(nextColumn, sym, Object.getOwnPropertyDescriptor(column, sym));
      }

      nextColumn.isVisible = value;
