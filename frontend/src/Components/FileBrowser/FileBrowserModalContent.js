        ...
        >
          {
            isWindowsService &&
              <Alert
                ...
                kind={kinds.WARNING}
              >
                {translate('FileBrowserWindowsServicePrefix')} <Link className={styles.faqLink} to="https://discord.gg/nqFGsGUug2">{translate('FileBrowserFaqLinkText')}</Link> {translate('FileBrowserWindowsServiceSuffix')}
              </Alert>
          }
