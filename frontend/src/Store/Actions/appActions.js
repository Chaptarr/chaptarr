...
export function getDefaultImportTracker() {
  return {
    isActive: false,
    stage: null,
    message: null,
...
export const defaultState = {
  ...
  version: window.Chaptarr.version,
  isUpdated: false,
  isConnected: true,
  ...
  hideUnmonitoredMissing: JSON.parse(localStorage.getItem('hideUnmonitoredMissing') || 'false'),
...
export const TOGGLE_HIDE_UNMONITORED_MISSING = 'app/toggleHideUnmonitoredMissing';
export const SET_SELECTED_MEDIA_TYPE = 'app/setSelectedMediaType';
...
export const toggleHideUnmonitoredMissing = createAction(TOGGLE_HIDE_UNMONITORED_MISSING);
export const setSelectedMediaType = createAction(SET_SELECTED_MEDIA_TYPE);
...
export const reducers = createHandleActions({
  ...
  [TOGGLE_HIDE_UNMONITORED_MISSING]: function(state) {
    const newValue = !state.hideUnmonitoredMissing;
    
    // Save to localStorage for persistence
    localStorage.setItem('hideUnmonitoredMissing', JSON.stringify(newValue));
    
    return Object.assign({}, state, {
      hideUnmonitoredMissing: newValue
    });
  },
