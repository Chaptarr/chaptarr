...
export const CANCEL_FETCH_INTERACTIVE_IMPORT_ITEMS = 'interactiveImport/cancelFetchInteractiveImportItems';
...
export const cancelFetchInteractiveImportItems = createThunk(CANCEL_FETCH_INTERACTIVE_IMPORT_ITEMS);
...
export const actionHandlers = handleThunks({
  [FETCH_INTERACTIVE_IMPORT_ITEMS]: function(getState, payload, dispatch) {
    ...
    const currentAbortRequest = abortRequest;
  ...
  [CANCEL_FETCH_INTERACTIVE_IMPORT_ITEMS]: function() {
    if (abortCurrentFetchRequest) {
      abortCurrentFetchRequest();
      abortCurrentFetchRequest = null;
    }
  ...
  [SAVE_INTERACTIVE_IMPORT_ITEM]: function(getState, payload, dispatch) {
    ...
    const requestPayload = payload.ids.map((id) => {
      ...
      return {
        ...
        editionId: item.editionId ? item.editionId : undefined,
        suggestedForeignAuthorId: item.suggestedForeignAuthorId,
        suggestedAuthorName: item.suggestedAuthorName,
        suggestedForeignBookId: item.suggestedForeignBookId,
        suggestedBookTitle: item.suggestedBookTitle,
        suggestedForeignEditionId: item.suggestedForeignEditionId,
        suggestedEditionTitle: item.suggestedEditionTitle,
