  ...
  reducers: {
    ...
    [SELECT_INDEXER_SCHEMA]: (state, { payload }) => {
      return selectProviderSchema(state, section, payload, (selectedSchema) => {
        selectedSchema.enableRss = selectedSchema.enableRss ?? selectedSchema.supportsRss;
        selectedSchema.enableAutomaticSearch = selectedSchema.enableAutomaticSearch ?? selectedSchema.supportsSearch;
        selectedSchema.enableInteractiveSearch = selectedSchema.enableInteractiveSearch ?? selectedSchema.supportsSearch;

        // Apply any pending changes from the payload
        if (payload.pendingChanges) {
          Object.assign(selectedSchema, payload.pendingChanges);
        }
