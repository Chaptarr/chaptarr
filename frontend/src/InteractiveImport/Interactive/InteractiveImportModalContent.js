...
import { align, icons, inputTypes, kinds, scrollDirections } from 'Helpers/Props';
...
class InteractiveImportModalContent extends Component {
  ...
  render() {
    ...
    const willAddCount = items.filter((item) => !isLocalReady(item) && item.suggestedForeignAuthorId).length;
    const needsChoiceCount = Math.max(items.length - readyNowCount - willAddCount, 0);
    ...
    return (
      <ModalContent onModalClose={onModalClose}>
        <ModalHeader>
          {translate('ManualImportHeader', { title: title || folder })}
        </ModalHeader>
                  ...
                  <Menu alignMenu={align.RIGHT}>
                    <MenuButton>
                      ...
                      <div className={styles.filterText}>
                        {
                          filterExistingFiles ? translate('InteractiveImportUnmappedFilesOnly') : translate('InteractiveImportAllFiles')
                        }
                      </div>
                    </MenuButton>
                    ...
                    <MenuContent>
                      ...
                      >
                        {translate('InteractiveImportAllFiles')}
                      </SelectedMenuItem>
                      ...
                      <SelectedMenuItem
                        ...
                        onPress={this.onFilterExistingFilesChange}
                      >
                        {translate('InteractiveImportUnmappedFilesOnly')}
                      </SelectedMenuItem>
                    </MenuContent>
                  </Menu>
              }
                ...
                showReplaceExistingFiles &&
                  <Menu alignMenu={align.RIGHT}>
                    <MenuButton>
                      ...
                      <div className={styles.filterText}>
                        {
                          replaceExistingFiles ? translate('InteractiveImportReplaceExistingMode') : translate('InteractiveImportCombineWithExistingMode')
                        }
                      </div>
                    </MenuButton>
                    ...
                    <MenuContent>
                      ...
                      >
                        {translate('InteractiveImportCombineWithExisting')}
                      </SelectedMenuItem>
                      ...
                      <SelectedMenuItem
                        ...
                        onPress={this.onReplaceExistingFilesChange}
                      >
                        {translate('InteractiveImportReplaceExisting')}
                      </SelectedMenuItem>
                    </MenuContent>
                  </Menu>
              }
            ...
            isFetching &&
              <div className={styles.loadingContainer}>
                ...
                <div className={styles.loadingText}>
                  {translate('ManualImportAnalyzingFiles')}
                </div>
              </div>
          }
...

          {
            isPopulated && !!items.length && !isFetching ?
              <div className={styles.matchSummary}>
                <Label kind={kinds.SUCCESS}>{`Ready now (local): ${readyNowCount}`}</Label>
                <Label kind={kinds.INFO}>{`Will add from metadata: ${willAddCount}`}</Label>
                <Label kind={kinds.WARNING}>{`Needs manual choice: ${needsChoiceCount}`}</Label>
              </div> :
              null
          }
          ...
          <div className={styles.leftButtons}>
            ...
            <div className={styles.matchingControl}>
              <FormInputGroup
                ...
                isDisabled={isStrictMatching || isPathFallbackBusy || isFetching}
