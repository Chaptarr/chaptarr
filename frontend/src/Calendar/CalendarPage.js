...
class CalendarPage extends Component {
  ...
  render() {
    ...
    const showMonitoredEmptyState = selectedFilterKey === 'monitored' &&
      calendarIsPopulated &&
      !calendarIsFetching &&
    ...
    return (
      <PageContent title={translate('Calendar')}>
        ...
        >
          ...
          {
            !authorError && authorIsPopulated && hasAuthor && showMonitoredEmptyState &&
              <div className={styles.emptyState}>
                <div className={styles.emptyStateMessage}>
                  {translate('NoMonitoredReleasesInThisRange')}
                </div>
...
CalendarPage.propTypes = {
  ...
  calendarItems: PropTypes.arrayOf(PropTypes.object).isRequired,
  calendarIsFetching: PropTypes.bool.isRequired,
  calendarIsPopulated: PropTypes.bool.isRequired,
