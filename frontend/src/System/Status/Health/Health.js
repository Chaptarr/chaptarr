...
function getInternalLink(source) {
  switch (source) {
    ...
    case 'ImportListRootFolderCheck':
      return (
        <IconButton
          name={icons.SETTINGS}
  ...
  switch (source) {
    ...
    default:
      return (
        <SpinnerIconButton
          name={icons.TEST}
          title={translate('RerunHealthChecks')}
          isSpinning={props.isRunningHealthCheck}
          onPress={props.dispatchRunHealthCheck}
        />
      );
  }
}
