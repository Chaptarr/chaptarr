  ...
  render() {
    ...
    return (
      <TableRow>
        ...
        {
          executeNow && isQueued &&
            <TableRowCell className={styles.nextExecution}>{translate('ScheduledTaskQueued')}</TableRowCell>
        }

        {
          executeNow && !isQueued &&
            <TableRowCell className={styles.nextExecution}>{translate('ScheduledTaskNow')}</TableRowCell>
        }
