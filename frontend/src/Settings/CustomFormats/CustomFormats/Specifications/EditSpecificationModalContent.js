        ...
        >
          {
            fields && fields.some((x) => x.label === translate('CustomFormatsSpecificationRegularExpression')) &&
              <Alert kind={kinds.INFO}>
                <div>
                  <div>
                    {translate('CustomFormatsRegexExplainerPrefix')} <code>{'\\^$.|?*+()[{'}</code> {translate('CustomFormatsRegexExplainerSuffix')} <code>{'\\'}</code>
                  </div>
                  {translate('CustomFormatsRegexMoreDetails')} <Link to="https://www.regular-expressions.info/tutorial.html">{translate('CustomFormatsRegexHereLinkText')}</Link>
                </div>
                <div>
                  {translate('CustomFormatsRegexTestedPrefix')}
                  <Link to="http://regexstorm.net/tester">{translate('CustomFormatsRegexHereLinkText')}</Link>
                </div>
              </Alert>
          }
