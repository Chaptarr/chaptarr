...
import getNarratorNames from './getNarratorNames';
...
class Specification extends Component {
  ...
  render() {
    ...
    const narratorNames = getNarratorNames({ implementation, fields });
    ...
    return (
      ...
      >
        ...
        <div className={styles.labels}>
          ...
          {
            narratorNames.map((narratorName, index) => {
              return (
                <Label
                  key={index}
                  kind={negate ? kinds.DANGER : kinds.SUCCESS}
                >
                  {narratorName}
                </Label>
              );
