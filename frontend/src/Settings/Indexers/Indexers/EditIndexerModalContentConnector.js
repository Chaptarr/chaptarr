...
import { saveIndexer, setIndexerFieldValue, setIndexerValue, testIndexer, toggleAdvancedSettings, fetchProxies } from 'Store/Actions/settingsActions';
...
class EditIndexerModalContentConnector extends Component {
  ...
  componentDidMount() {
    // Ensure proxies are loaded so the per-indexer proxy dropdown is populated
