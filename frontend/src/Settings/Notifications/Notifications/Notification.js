  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {
          supportsOnBookAdded && onBookAdded ?
            <Label kind={kinds.SUCCESS}>
              {translate('OnBookAdded')}
            </Label> :
            null
        }
        ...
        {
          !onGrab && !onReleaseImport && !onRename && !onBookRetag && !onAuthorAdded && !onBookAdded && !onAuthorDelete && !onBookDelete && !onBookFileDelete && !onHealthIssue && !onDownloadFailure && !onImportFailure && !onApplicationUpdate ?
            <Label
              kind={kinds.DISABLED}
              outline={true}
            >
...
Notification.propTypes = {
  ...
  onBookAdded: PropTypes.bool.isRequired,
  ...
  supportsOnBookAdded: PropTypes.bool.isRequired,
