    ...
    return (
      <PageContent title={translate('GeneralSettings')}>
            ...
            hasSettings && isPopulated && !error &&
              ...
              >
                ...
                <ProxySettings
                  ...
                  testError={this.props.proxyTestError}
                  onInputChange={onInputChange}
                  onTestPress={onTestProxyPress}
                />
        ...
        <ConfirmModal
          ...
          kind={kinds.DANGER}
          title={translate('RestartChaptarr')}
          message={
            `Chaptarr requires a restart to apply changes, do you want to restart now? ${isWindowsService ? 'Depending which user is running the Chaptarr service you may need to restart Chaptarr as admin once before the service will start automatically.' : ''}`
          }
...
GeneralSettings.propTypes = {
  ...
  isTestingProxy: PropTypes.bool,
  proxyTestError: PropTypes.object,
  onInputChange: PropTypes.func.isRequired,
  onConfirmResetApiKey: PropTypes.func.isRequired,
  onConfirmRestart: PropTypes.func.isRequired,
  onTestProxyPress: PropTypes.func
};
