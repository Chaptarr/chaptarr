...
module.exports = {
  ...
  menuItemHoverColor: chaptarrRed,
  menuItemHoverBackgroundColor: '#606060',

  //
  // Toolbar

  toobarButtonHoverColor: chaptarrRed,
  toobarButtonSelectedColor: chaptarrRed,
